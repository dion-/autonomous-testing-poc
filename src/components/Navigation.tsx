...
export function Navigation({ currentStep, onSkipTo }: NavigationProps) {
  return (
    <nav
      aria-label="Checkout progress"
      className="w-full md:w-60 bg-gray-50/50 border-b md:border-b-0 md:border-r border-gray-100 flex-shrink-0"
    >
